defmodule SelfQuantifiedExWeb.FoodControllerTest do
  use SelfQuantifiedExWeb.ConnCase

  alias SelfQuantifiedEx.Api
  alias SelfQuantifiedEx.Api.Food

  @create_attrs %{calories: 42, name: "Pakawagalaga's Pawpaws"}
  @update_attrs %{calories: 420, name: "Opakawagalaga's Pawpaws"}
  @invalid_attrs %{calories: nil, name: nil}

  def fixture(:food) do
    {:ok, food} = Api.create_food(@create_attrs)
    food
  end
